...
#for saving plots headlessly
#(aliased: run() below uses "os" as a local var name for "overshoot")
import os as _os
...
#
        ...
        plots_dir = _os.path.join(_os.path.dirname(__file__), "..", "plots")
        _os.makedirs(plots_dir, exist_ok=True)
        plot_path = _os.path.join(plots_dir, self.formula_id + "_" + self.file_id + ".png")
        fig.savefig(plot_path)
        print("Saved plot to " + _os.path.abspath(plot_path))
